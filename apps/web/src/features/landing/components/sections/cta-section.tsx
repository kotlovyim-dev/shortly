...
export function CtaSection() {
    return (
        <section
            id="cta"
            className="scroll-mt-28 rounded-3xl border border-border/70 bg-linear-to-br from-primary/20 via-primary/8 to-background p-12 text-center shadow-[0_18px_70px_oklch(0.15_0_0/0.06)] backdrop-blur-xl sm:p-16 lg:p-20"
        >
